...
name: content-inbox
description: |
  Unified content management system. Auto-processes Douyin/Xiaohongshu/WeChat links, downloads content, then asks user how to handle it.

  USE FOR:
  - Message contains v.douyin.com → trigger immediately, don't wait
  - Message contains xiaohongshu.com → trigger immediately
